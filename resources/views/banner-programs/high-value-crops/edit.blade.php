			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-body">
						...
						<!-- Multi Columns Form -->
						<form class="row g-3" method="POST" action="{{ route('high-value-crops.update', $highValueCrop) }}">
							@csrf
							@method('PUT')
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<select class="form-control @error('farmer_barangay') is-invalid @enderror" id="farmer_barangay"
										...
										<option value="{{ $barangays }}" {{ old('barangays')|| $highValueCrop->farmer_barangay==$barangays ? 'selected' : '' }}>
											{{ $barangays }}
										</option>
										@endforeach
									</select>
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<textarea class="form-control" placeholder="Details Here..." name="crop_information" id="floatingTextarea" style="height: 100px;">{{ $highValueCrop->crop_information }}</textarea>
