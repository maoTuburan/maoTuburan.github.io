<x-app-layout>
	...
	<div class="text-center">
		<h1>
			<span class="badge bg-success">Rice Program</span>
		</h1>

	</div>

	<a href="{{ route('rices.create') }}" class="btn btn-primary">Add Farmer to Program</a>
		...
		<div class="col-lg-12">
			...
			<div class="card">
				<div class="card-body table-wrapper table-responsive">
					...
					<table class="table table-hover" id="rice-table">
						<thead>
							<tr>
								<th>Farmer's Name</th>
								<th>Barangay</th>
	...
	<x-modal modal-id="rice-modal" button-id="destroy-rice" type="delete" label="rice"/>

	@push('scripts')
		<script src="{{ asset('js/page/rice/index.js') }}"></script>
	@endpush
</x-app-layout>
