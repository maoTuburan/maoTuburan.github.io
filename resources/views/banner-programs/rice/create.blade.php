			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-body">
						...
						<!-- Multi Columns Form -->
						<form class="row g-3" method="POST" action="{{ route('rices.store') }}">
							@csrf
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<textarea class="form-control" placeholder="Details Here..." name="farm_details" id="floatingTextarea" style="height: 100px;"></textarea>
