<x-app-layout>
	<div class="pagetitle mb-4">
		<h1>Organic Agriculture Program</h1>
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="bi bi-house-door"></i></a></li>
				<li class="breadcrumb-item"><a href="{{ route('bannerPrograms') }}">Banner Program</a></li>
				<li class="breadcrumb-item"><a href="{{ route('organic-agricultures.index') }}">Organic Agriculture Program</a></li>
			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-body">
						...
						<!-- Multi Columns Form -->
						<form class="row g-3" method="POST" action="{{ route('organic-agricultures.update', $organic_agriculture) }}">
							@csrf
							@method('PUT')
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<select class="form-control @error('farmer_barangay') is-invalid @enderror" id="farmer_barangay"
										...
										<option value="{{ $barangays }}" {{ old('barangays')|| $organic_agriculture->farmer_barangay==$barangays ? 'selected' : '' }}>
											{{ $barangays }}
										</option>
										@endforeach
									</select>
							...
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<textarea class="form-control" placeholder="Details Here..." name="crop_information" id="floatingTextarea" style="height: 100px;">{{ $organic_agriculture->crop_information }}</textarea>
									<label for="floatingTextarea">Crop Information</label>
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-floating mb-3">
									<textarea class="form-control" placeholder="Details Here..." name="livestock_details" id="floatingTextarea" style="height: 100px;">{{ $organic_agriculture->livestock_details }}</textarea>
									<label for="floatingTextarea">Livestock Details</label>
								</div>
							</div>
							<x-insurance.status-update :insuranceStatus="$insuranceStatus" />
							<div class="text-start">
								<a href="{{ route('organic-agricultures.index') }}" class="btn btn-secondary">Back</a>
