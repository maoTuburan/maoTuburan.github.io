<x-app-layout>
	...
	<div class="text-center">
		<h1>
			<span class="badge bg-success">Corn Program</span>
		</h1>

	</div>

	<a href="{{ route('corns.create') }}" class="btn btn-primary">Add Farmer to Program</a>
		...
		<div class="col-lg-12">
			...
			<div class="card">
				<div class="card-body table-wrapper table-responsive">
					...
					<table class="table table-hover" id="corn-table">
						<thead>
							<tr>
								<th>Farmer's Name</th>
								<th>Barangay</th>
	...
	<x-modal modal-id="corn-modal" button-id="destroy-corn" type="delete" label="corn"/>

	@push('scripts')
		<script src="{{ asset('js/page/corn/index.js') }}"></script>
	@endpush
</x-app-layout>
